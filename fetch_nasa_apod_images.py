...
from download_helpers import create_directory, download_image, get_file_extension
...
def main():
    ...
    fetch_nasa_apod_images(nasa_apod_url, nasa_request_params, images_directory)
